...
// Registra um novo trancista, incluindo informações como:
// cpfcnpj, email, nome, telefone, data de nascimento, genero,
...
$cpfcnpj = filter_var(isset($_POST['cpfcnpj']) ? trim($_POST['cpfcnpj']) : '', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
